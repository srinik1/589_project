    ...
    if(tree_node.isLeafNode) :
        ...
        if(tree_node.valueToCheck != None) :
            ...
            try:
                ...
                print("fkljasdkffkdsjklfjksdjlfksjkldjlkafsjlklkdjsfl")
...
def main() :
    ...
    output_type = "str"
    str_attrib_list = ["Pclass","Sex"]
    
    input_dataset = input_dataset.drop("Name", axis=1)
